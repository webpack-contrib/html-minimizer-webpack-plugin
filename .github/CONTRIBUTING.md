...
{
  "devDependencies": {
    "html-minimizer-webpack-plugin": "webpack-contrib/html-minimizer-webpack-plugin#{id}/head"
  }
}
```
...
When submitting your contribution, a CLA (Contributor License Agreement) bot will come by to verify that you signed the [CLA](https://cla.js.foundation/webpack-contrib/html-minimizer-webpack-plugin).
